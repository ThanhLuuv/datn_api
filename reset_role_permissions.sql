-- ============================================
-- Script để xóa và tạo lại role_permission
-- Role IDs trong database hiện tại:
-- role_id = 1: CUSTOMER
...
-- Bước 3: Seed Permissions (Quyền) - Đảm bảo có đủ 42 permissions
...
-- Bước 4: Insert lại role_permission với role_id đúng

-- 4.1. ADMIN (RoleId = 3) - Có TẤT CẢ 42 permissions
...
-- 4.4. CUSTOMER (RoleId = 1) - Khách hàng
INSERT INTO `role_permission` (`role_id`, `permission_id`) VALUES
...
-- role_id = 2 (SALES_EMPLOYEE): 24 permissions
