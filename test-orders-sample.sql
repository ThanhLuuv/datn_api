...
-- 11. Insert order lines for each order
INSERT IGNORE INTO order_line (order_line_id, order_id, isbn, qty, unit_price) VALUES
-- Order 1001
(2001, 1001, '9781234567890', 1, 50000),

-- Order 1002
(2002, 1002, '9781234567891', 1, 75000),

-- Order 1003
(2003, 1003, '9781234567892', 1, 100000),

-- Order 1004
(2004, 1004, '9781234567890', 1, 50000),
(2005, 1004, '9781234567891', 1, 75000),

-- Order 1005
(2006, 1005, '9781234567890', 1, 50000),
(2007, 1005, '9781234567891', 1, 75000),
(2008, 1005, '9781234567892', 1, 100000);

-- 12. Insert some assigned orders (for testing different scenarios)
INSERT IGNORE INTO `order` (order_id, customer_id, placed_at, receiver_name, receiver_phone, shipping_address, status, approved_by, delivered_by, delivery_date) VALUES
(1006, 1, NOW(), 'Nguyen Van Customer', '0904444444', '999 Phường Phú Mỹ, TP. Vũng Tàu', 1, 1, 1, DATE_ADD(NOW(), INTERVAL 1 DAY)),
(1007, 2, NOW(), 'Tran Thi Customer', '0905555555', '888 Phường Tam Long, TP. Vũng Tàu', 1, 1, 2, DATE_ADD(NOW(), INTERVAL 2 DAY));

INSERT IGNORE INTO order_line (order_line_id, order_id, isbn, qty, unit_price) VALUES
(2009, 1006, '9781234567890', 2, 50000),
(2010, 1006, '9781234567891', 2, 75000),
(2011, 1007, '9781234567892', 1, 100000),
(2012, 1007, '9781234567890', 1, 50000),
(2013, 1007, '9781234567891', 1, 75000);

-- 13. Insert some delivered orders (for testing employee workload)
INSERT IGNORE INTO `order` (order_id, customer_id, placed_at, receiver_name, receiver_phone, shipping_address, status, approved_by, delivered_by, delivery_date) VALUES
(1008, 3, NOW(), 'Le Van Customer', '0906666666', '777 Phường Tân Thành, TP. Vũng Tàu', 2, 1, 1, DATE_SUB(NOW(), INTERVAL 1 DAY)),
(1009, 4, NOW(), 'Pham Thi Customer', '0907777777', '666 Phường Bàn Cờ, Quận 3, TP.HCM', 2, 1, 2, DATE_SUB(NOW(), INTERVAL 2 DAY));

INSERT IGNORE INTO order_line (order_line_id, order_id, isbn, qty, unit_price) VALUES
(2014, 1008, '9781234567890', 3, 50000),
(2015, 1008, '9781234567891', 2, 75000),
(2016, 1009, '9781234567892', 2, 100000),
(2017, 1009, '9781234567890', 1, 50000);
