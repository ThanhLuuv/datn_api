...
namespace BookStore.Api.Migrations
{
    ...
    [Migration("20251121144845_AddAiDocuments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Api.Models.AiDocument", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BookStore.Api.Models.ExpenseVoucher", b =>
                {
                    b.Property<long>("ExpenseVoucherId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("expense_voucher_id");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<long>("ExpenseVoucherId"));
                    ...
                    b.HasKey("ExpenseVoucherId");

                    b.HasIndex("ApprovedBy");

                    b.HasIndex("CreatedBy");

                    b.ToTable("expense_voucher");
                });

            modelBuilder.Entity("BookStore.Api.Models.ExpenseVoucherLine", b =>
                {
                    b.Property<long>("ExpenseVoucherLineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("expense_voucher_line_id");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<long>("ExpenseVoucherLineId"));
                    ...
                    b.HasKey("ExpenseVoucherLineId");

                    b.HasIndex("ExpenseVoucherId");

                    b.ToTable("expense_voucher_line");
                });
            ...
            modelBuilder.Entity("BookStore.Api.Models.Return", b =>
                {
                    ...
                    b.Property<bool>("ApplyDeduction")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("apply_deduction");
            ...
            modelBuilder.Entity("BookStore.Api.Models.ExpenseVoucher", b =>
                {
                    b.HasOne("BookStore.Api.Models.Employee", "Approver")
                        .WithMany()
                        .HasForeignKey("ApprovedBy");

                    b.HasOne("BookStore.Api.Models.Employee", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore.Api.Models.ExpenseVoucherLine", b =>
                {
                    b.HasOne("BookStore.Api.Models.ExpenseVoucher", "ExpenseVoucher")
                        .WithMany("ExpenseVoucherLines")
            ...
            modelBuilder.Entity("BookStore.Api.Models.ExpenseVoucher", b =>
                {
                    b.Navigation("ExpenseVoucherLines");
                });
